...
pluralCaseList.push( {plural: "courseManagements", pascal: "CourseManagement"} )

pluralCaseList.push( {plural: "professorApplyments", pascal: "ProfessorApplyment"} )

pluralCaseList.push( {plural: "professorEvaluations", pascal: "ProfessorEvaluation"} )

pluralCaseList.push( {plural: "smsHistories", pascal: "SmsHistory"} )


pluralCaseList.push( {plural: "applyStatusInquiries", pascal: "ApplyStatusInquiry"} )
